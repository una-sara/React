...
//对于 是 export default {} 写法导出的
//差别只在于不用写 * as
// import exp4 from './export4.js'
// console.log(exp4.a, exp4.add(5,6), exp4.getCompanyName())

//问题: exp4.getCompanyName()  代码比较长, 不容易读, 因为带有前缀 exp4

//混合引入方式: 引入所有的的, 命名为 exp4
//对于特殊的一些值, 进行额外的特殊引入,便于使用
